...
@Component
public class ReviewMapper extends GenericMapper<Review, ReviewDTO> implements ConverterForSpecificFields<Review, ReviewDTO> {
    ...
    public void setupMapper() {
        modelMapper.createTypeMap(Review.class, ReviewDTO.class).addMappings(m -> {
            m.skip(ReviewDTO::setFilmId);
            m.skip(ReviewDTO::setUserDTO);
        }).setPostConverter(toDtoConverter());

        modelMapper.createTypeMap(ReviewDTO.class, Review.class).addMappings(m -> {
